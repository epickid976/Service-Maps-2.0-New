...
//Swift
//
//class PhoneNumber: Object, Identifiable {
...
//    }
//    
//    static func == (lhs: PhoneNumber, rhs: PhoneTerritory) -> Bool {
...
//      }
//    
//    func createTerritoryObject(from model: PhoneTerritory) -> PhoneNumber {
//      let territoryObject = PhoneNumber()
