...
//            case .Territory:
//                await tryAction(pendingChange: pendingChange, items: DatabaseManager.shared.getTerritories()) { model in
//                    model.id ?? ""
//                } onAdd: { model in
//                    do {
...
//                    DatabaseManager.shared.container.viewContext.delete(model)
//                }
//
//            case .House:
//                await tryAction(pendingChange: pendingChange, items: DatabaseManager.shared.getHouses()) { model in
//                    model.id ?? ""
//                } onAdd: { model in
//                    do {
...
//                
//            case .Visit:
//                await tryAction(pendingChange: pendingChange, items: DatabaseManager.shared.getVisits()) { model in
//                    model.id ?? ""
//                } onAdd: { model in
//                    do {
...
//                await tryAction(pendingChange: pendingChange, items: DatabaseManager.shared.getTerritoryAddresses()) { model in
//                    model.id ?? ""
//                } onAdd: { model in
//                    do {
