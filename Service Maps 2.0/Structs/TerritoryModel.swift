...
//import Foundation
//
//struct Territory: Codable, Equatable, Hashable, Identifiable {
//    var id: String
...
//
//
//func convertTerritoryToTerritoryModel(model: Territory) -> Territory {
//    return Territory(id: model.id, congregation: model.congregation, number: model.number, description: model.territoryDescription, image: model.image, created_at: "", updated_at: "")
//}
